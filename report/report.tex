...
The source code is also included in the appendix and is organized with code implementing the core backpropagation algorithm and network structure up front, with less critical I/O and support code behind. Of particular interest is the edu.gmu.classifier.neuralnet.train.Backpropagation class, which implements the stochastic backpropagation algorithm, the edu.gmu.classifier.neuralnet.net.AbstractNet class, which handles network construction and calculation of network output, and the edu.gmu.classifier.neuralnet.node.SigmoidNode class, which provides error, output, and weight update calculations specific to networks using a sigmoid activation function (see Equation \ref{sigmoid1}).
